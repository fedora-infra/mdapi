...
* Follow the development steps from the **"Development > Natively"** section in README.md
...
* Use `pre-commit run --all-files` against all the files for linting and formating the codebase as per standards.
